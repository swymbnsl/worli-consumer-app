...
export default function DeliveryCalendar({
  ...
  const getOrderStatus = (date: string) => {
    ...
    const order = orders.find((o) => o.delivery_date === date)
        ...
        {days.map((date, idx) => {
          ...
          return (
            ...
            >
              ...
              <View className="mt-2">
                {status === "delivered" && (
                  <View className="w-2 h-2 rounded-full bg-functional-success" />
                )}
                {status === "upcoming" && (
                  <View className="w-2 h-2 rounded-full bg-secondary-skyBlue" />
                )}
              </View>
            </View>
          )
