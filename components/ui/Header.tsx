...
export default function Header({
  ...
  return (
    <View className="flex-row items-center justify-between px-4 py-4 bg-white shadow-sm z-10">
      ...
      <TouchableOpacity
        className="flex-row items-center gap-2 bg-secondary-skyBlue/20 rounded-full px-4 py-2 active:opacity-80"
        onPress={onLocationPress}
      >
        <MapPin color="#101B53" size={16} />
        <Text className="font-comfortaa-bold text-sm text-primary-navy font-semibold">
          {location}
        </Text>
