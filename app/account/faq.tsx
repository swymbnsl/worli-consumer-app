  ...
  const faqs = [
    {
      ...
      answer: 'You can place an order by navigating to the Home screen and clicking on "Order Now". Select your quantity and delivery date, then proceed to checkout.',
    },
    {
      question: 'What are the delivery timings?',
      answer: 'We deliver fresh milk daily between 6:00 AM to 8:00 AM. You can modify your delivery preferences in your account settings.',
    },
    {
      question: 'How do I pause my subscription?',
      answer: 'Go to the Subscription tab, tap on "Pause", and select the dates you want to pause. You can pause up to 7 days in advance.',
    },
    {
      question: 'How do I add money to my wallet?',
      answer: 'Navigate to the Wallet tab and tap on "Add Money". Enter the amount you want to add and complete the payment using your preferred method.',
    },
    {
      question: 'What if I need to return bottles?',
      answer: 'You can mark bottles as returned in the Orders section. Simply tap on the order and click "Mark as Returned". Our delivery person will collect empty bottles during the next delivery.',
    },
    {
      question: 'Can I change my delivery address?',
      answer: 'Yes, go to Account > Manage Addresses to add, edit, or delete delivery addresses. You can set a default address for regular deliveries.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Go to the Subscription tab and scroll down to find the "Cancel Subscription" button. Please note that you need to clear any pending bottle returns before cancellation.',
    },
  ];
