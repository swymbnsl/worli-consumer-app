      ...
      <ScrollView showsVerticalScrollIndicator={false} bounces={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View className="flex-row justify-between px-4 mt-8 mb-6">
            ...
            >
                ...
                <Text className="font-comfortaa text-xs text-primary-navy mt-2 text-center font-semibold">Orders</Text>
            </TouchableOpacity>
             <TouchableOpacity 
            ...
            >
                ...
                <Text className="font-comfortaa text-xs text-primary-navy mt-2 text-center font-semibold">History</Text>
            </TouchableOpacity>
             <TouchableOpacity 
            ...
            >
                ...
                <Text className="font-comfortaa text-xs text-primary-navy mt-2 text-center font-semibold">Support</Text>
            </TouchableOpacity>
        </View>
