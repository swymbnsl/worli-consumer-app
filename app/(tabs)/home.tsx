...
const CATEGORIES = [
  { id: 1, name: 'A2 Milk', image: 'https://placehold.co/100x100/F5F5F0/101B53.png?text=Milk' },
  { id: 2, name: 'Buffalo Milk', image: 'https://placehold.co/100x100/F5F5F0/101B53.png?text=Buffalo' },
  { id: 3, name: 'Ghee', image: 'https://placehold.co/100x100/F5F5F0/101B53.png?text=Ghee' },
  { id: 4, name: 'Paneer', image: 'https://placehold.co/100x100/F5F5F0/101B53.png?text=Paneer' },
];
  ...
  return (
    <SafeAreaView className="flex-1 bg-neutral-lightCream" edges={['top', 'bottom']}>
      ...
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#101B53" />}
      ...
      >
        ...
        {unreturnedBottles > 0 && (
          <View className="mb-6">
            <BottleReturnAlert count={unreturnedBottles} onPress={() => router.push('/(tabs)/orders')} />
          </View>
        )}

        {/* Promotional Carousel */}
        <View className="mb-6">
            <Text className="font-sofia text-lg font-bold text-primary-navy mb-4">Special Offers</Text>
            <PremiumCard onPress={() => router.push('/(tabs)/wallet')} />
        </View>

        {/* All Categories Grid */}
        <View className="mb-6">
            <Text className="font-sofia text-lg font-bold text-primary-navy mb-4">All Categories</Text>
